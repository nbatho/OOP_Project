...
INSERT INTO `comments` VALUES ('CM1762799105676','TK10','U_ADMIN','hoàn thiện đầy đủ thông tin nhé','2025-11-10 11:25:06'),('CM3','TK15','U18','Sử dụng GitLab CI/CD hay Jenkins?','2025-11-10 08:33:15');
...
INSERT INTO `tasks` VALUES ('4e4a753d-a865-4da3-8c8a-acbe06f8a77a','P3','User tao tho','THO','TODO','HIGH','2025-11-27','a53508eb-813c-4f67-bde7-de0eaef69bcb','2025-11-26 08:26:11'),('5f0443fc-3613-4a4e-aebb-2131a671e27b','P2','demo','123','IN_PROGRESS','HIGH','2025-11-27','a53508eb-813c-4f67-bde7-de0eaef69bcb','2025-11-26 08:44:54'),('63cf2210-607f-495e-a5d8-c0b7bab61e7e','P2','Test Delete','demo','TODO','HIGH','2025-11-26','a53508eb-813c-4f67-bde7-de0eaef69bcb','2025-11-26 08:12:29'),('7ea2cfdb-9c6d-4623-8289-1e0305f49a5e','P2','hehe','hehe','TODO','HIGH','2025-11-27','a53508eb-813c-4f67-bde7-de0eaef69bcb','2025-11-26 08:46:02'),('8f8b0367-f5e8-44b0-9be3-9fa1b24a0afd','P4','Nghich thu','','TODO','LOW','2025-11-27','a53508eb-813c-4f67-bde7-de0eaef69bcb','2025-11-25 12:32:08'),('b15d0a1b-4364-4989-bf87-095c9be55ee5','4826f8f7-f519-48e1-a593-f7cf59d501b6','ọc ọc 123','','TODO','HIGH','2025-11-26','a53508eb-813c-4f67-bde7-de0eaef69bcb','2025-11-29 03:37:22'),('d39b66ba-7f0b-4f6b-ad87-ad4e43bb78fa','5fb21d79-a9fb-4d33-8dc0-5a4656f666cc','123','123','DONE','HIGH','2025-11-27','a53508eb-813c-4f67-bde7-de0eaef69bcb','2025-11-28 08:11:15'),('f76ef839-4a2d-46b0-a73f-56dc9c7a6dfc','P4','demo','omed','IN_PROGRESS','HIGH','2025-11-28','a53508eb-813c-4f67-bde7-de0eaef69bcb','2025-11-25 12:41:53'),('fedf492d-0828-436f-8a60-bebef9bd60c8','5fb21d79-a9fb-4d33-8dc0-5a4656f666cc','123','123','TODO','HIGH','2025-11-28','a53508eb-813c-4f67-bde7-de0eaef69bcb','2025-11-27 07:14:00'),('TK10','P2','Prototype mobile screens','Tạo bản mẫu (prototype) chi tiết cho các màn hình di động.','TODO','HIGH','2025-11-25','U14','2025-11-10 08:33:15'),('TK11','P2','Test mobile app trên 3 thiết bị','Kiểm thử khả năng tương thích của ứng dụng trên iOS, Android và Tablet.','TODO','HIGH','2025-12-20','U12','2025-11-10 08:33:15'),('TK12','P2','Requirement gathering','Thu thập và phân tích yêu cầu nghiệp vụ chi tiết.','DONE','LOW','2025-11-12','U14','2025-11-10 08:33:15'),('TK13','P3','JWT Access/Refresh token','Phát triển logic tạo, kiểm tra và làm mới JWT.','TODO','HIGH','2025-11-28','U5','2025-11-10 08:33:15'),('TK14','P3','OAuth2 Google Login','Tích hợp đăng nhập thông qua Google OAuth2.','TODO','LOW','2025-12-05','U5','2025-11-10 08:33:15'),('TK15','P3','CI/CD pipeline','Xây dựng pipeline tự động hóa triển khai (Deployment) cho Auth Service.','TODO','HIGH','2025-12-10','U5','2025-11-10 08:33:15'),('TK16','P3','Test login & token expiration','Kiểm thử bảo mật đăng nhập và cơ chế hết hạn token.','TODO','LOW','2025-12-12','U7','2025-11-10 08:33:15'),('TK17','P4','Admin table UI + pagination','Xây dựng giao diện bảng quản trị với chức năng phân trang.','TODO','LOW','2025-11-30','U13','2025-11-10 08:33:15'),('TK18','P4','Dashboard charts','Thiết kế và triển khai các biểu đồ hiển thị dữ liệu trên Dashboard.','TODO','LOW','2025-12-05','U13','2025-11-10 08:33:15'),('TK19','P4','Functional specification','Viết tài liệu đặc tả chức năng chi tiết cho toàn bộ Dashboard.','DONE','LOW','2025-11-18','U13','2025-11-10 08:33:15'),('TK2','P1','Product Detail UI + Responsive','Phát triển trang chi tiết sản phẩm, đảm bảo hiển thị tốt trên di động.','TODO','HIGH','2025-12-10','U13','2025-11-10 08:33:15'),('TK20','P4','Regression test','Thực hiện kiểm thử hồi quy cho toàn bộ chức năng hiện có.','TODO','LOW','2025-12-10','U1','2025-11-10 08:33:15'),('TK21','P5','LLM API integration','Tích hợp API của mô hình ngôn ngữ lớn (LLM) vào Backend.','TODO','HIGH','2025-12-15','U14','2025-11-10 08:33:15'),('TK22','P5','Deploy inference server','Triển khai máy chủ suy luận (Inference Server) cho mô hình AI.','TODO','HIGH','2025-12-20','U14','2025-11-10 08:33:15'),('TK23','P5','Test conversation flows','Kiểm thử các kịch bản hội thoại phức tạp của Chatbot.','TODO','LOW','2025-12-22','U14','2025-11-10 08:33:15'),('TK24','P5','Business flow diagrams','Thiết kế sơ đồ luồng nghiệp vụ của Chatbot.','DONE','LOW','2025-11-15','U14','2025-11-10 08:33:15'),('TK3','P1','API Products (CRUD)','Xây dựng API cho phép Thêm, Đọc, Cập nhật, Xóa sản phẩm.','TODO','HIGH','2025-11-25','U12','2025-11-10 08:33:15'),('TK4','P1','Payment Integration','Tích hợp cổng thanh toán bên thứ ba (ví dụ: VNPAY/Momo).','TODO','HIGH','2025-12-15','U12','2025-11-10 08:33:15'),('TK6','P1','Test payment flow','Xây dựng kịch bản và thực hiện kiểm thử end-to-end luồng thanh toán.','TODO','HIGH','2025-12-16','U12','2025-11-10 08:33:15'),('TK7','P1','Viết SRS + Use Case','Tài liệu đặc tả yêu cầu phần mềm và các trường hợp sử dụng.','DONE','LOW','2025-11-15','U12','2025-11-10 08:33:15'),('TK8','P2','Write booking UI on React Native','Xây dựng giao diện đặt lịch trên ứng dụng di động.','TODO','LOW','2025-12-05','U14','2025-11-10 08:33:15'),('TK9','P2','API schedule / booking','Xây dựng các API quản lý lịch hẹn và đặt chỗ.','TODO','HIGH','2025-12-10','U14','2025-11-10 08:33:15');
...
-- Dump completed on 2025-11-29 19:15:00
